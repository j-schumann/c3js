...
class LineChart extends BaseChart {
	...
	public function setXAxis($id) {
		if (!is_int($id) || $id < 1) {
			throw new InvalidArgumentException('Axis id has to be an integer and equal or bigger than 1.');
		}
	...
	public function setYAxis($id) {
		if (!is_int($id) || $id < 1 || $id > 2) {
			throw new InvalidArgumentException('YAxis id has to be 1 or 2.');
		}
